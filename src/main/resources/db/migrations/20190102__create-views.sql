...
COMMENT ON VIEW financial.wb_view_001
  IS 'List by the open financial periods all cost centers and the respective value spent or received in each one';
...
COMMENT ON VIEW financial.wb_view_002
  IS 'List by the open financial periods all movement classes and the value spent or received in each one';
...
COMMENT ON VIEW financial.wb_view_003
  IS 'Quick resume of the open financial periods';

-- materialized view 001
...
COMMENT ON MATERIALIZED VIEW financial.wb_mview_001
  IS 'Quick resume of all closed financial periods';