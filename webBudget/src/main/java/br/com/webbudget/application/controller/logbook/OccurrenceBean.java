...
import br.com.webbudget.domain.model.entity.logbook.Occurrence;
...
public class OccurrenceBean extends AbstractBean {
    ...
    @Getter
    private final AbstractLazyModel<Occurrence> occurrencesModel;
    ...
    public OccurrenceBean() {
        ...
        this.occurrencesModel = new AbstractLazyModel<Occurrence>() {
            @Override
            public List<Occurrence> load(int first, int pageSize, String sortField, 
                ...
                final Page<Occurrence> page = new Page<>(new ArrayList<>(), 0L);
